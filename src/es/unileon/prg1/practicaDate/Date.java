package es.unileon.prg1.practicaDate;
...
public class Date{
    ...
    */
    ...
    public Date(int day, int month, int year) throws DateException{
        ...
        /**
        * Se comprueba que el a��o es correcto
        */
        ...
        */
        ...
        if (month <= 0 || month >= 13){
			throw new DateException("Mes " + month + " no valido. Los valores deben estar entre 1 y 12.");
		}else{
			this.month = month;
		}

        /**
        * Se comprueba que el dia es correcto
        */
        ...
        switch(this.month){
            ...
            case 12:
                    if(day <= 0 || day > 31){
                        throw new DateException("Dia " + day + " no valido. Los valores deben estar entre 1 y 31.");
		            }else{
			            this.day = day;
		            }
                    break;
            ...
            case 11:
                    if(day <= 0 || day > 30){
                        throw new DateException("Dia " + day + " no valido. Los valores deben estar entre 1 y 30.");
		            }else{
			            this.day = day;
		            }
                    break;
            default:
                    if(day <= 0 || day > 28){
                        throw new DateException("Dia " + day + " no valido. Los valores deben estar entre 1 y 28.");
		            }else{
			            this.day = day;
		            }
    ...
    public void setYear(int year) throws DateException{
        ...
        /**
        * Se comprueba que el anyo es correcto
        */
    ...
    /**
    * Se comprueba si es el mismo anyo
    * @param another
    * @return
    */
    ...
    public boolean isSameYear(Date another){
        ...
        if(this.year == another.getYear()){
            mismoAnyo == true;
            System.out.println("��Tienen el mismo a��o?");
        }else{
            mismoAnyo = false;
            System.out.println("��Tienen el mismo a��o?");
        }
    ...
    /**
    * Se comprueba si es el mismo mes
    * @param another
    * @return
    */
    ...
    /**
    * Se comprueba si es el mismo dia
    * @param another
    * @return
    */
    ...
    */
    ...
    public Date tomorrow(){
    	...
    	aMonth = month;
    	/**
    	 * Se comprueba si hay que cambiar de mes
    	 */
    	if(aMonth > 12){
    		aDay = 1;
    		aMonth = 1;
